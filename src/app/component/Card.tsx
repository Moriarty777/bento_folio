...
const Card = ({
  ...
  return (
    <div
      ...
      className={`animate-fadeIn will-change-transform will-change-opacity relative flex flex-col items-center justify-center overflow-hidden rounded-3xl p-6 text-center text-lg font-medium ${textColor} shadow-[0_4px_10px_#8CBFAD] transition-all col-span-${col} row-span-${row} ${hoverClass}`}
    >
...
style={
  {
    "--fade-delay": delay, // TypeScript doesn't know about `--fade-delay`
    backgroundImage: `linear-gradient(to left, ${gradientFrom}, ${gradientTo})`,
    boxShadow: `0 4px 10px ${gradientTo}`,
  } as React.CSSProperties
}
